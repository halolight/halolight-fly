...
// VERCEL: Vercel 构建时自动注入
// FLY_APP_NAME: Fly.io 运行时注入
// ============================================================================
...
// Fly.io 和其他 Docker 环境始终使用 standalone 模式
const useStandalone = isFly || process.env.STANDALONE === "true" || (!isCloudflare && !isVercel);
